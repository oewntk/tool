...
./pack_json.sh "${TAG}" "${BUILD}" "out/json" "${distdir}/json" "json"
./pack_json.sh "${TAG}" "${BUILD}" "out/jsondata" "${distdir}/json" "jsondata"
./pack_json.sh "${TAG}" "${BUILD}" "out/jsonmodel" "${distdir}/json" "jsonmodel"
